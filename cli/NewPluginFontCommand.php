...
/**
 * Class NewPluginFontCommand
 * @package Grav\Console\Cli\DevTools
 */
class NewPluginFontCommand extends PhotonCommand
{
    ...
    {
        $this
            ->setName('new-plugin-font')
            ->setAliases(['newpluginfont'])
            ->addOption(
                'name',
                'pn',
