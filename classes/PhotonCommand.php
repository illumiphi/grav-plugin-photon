 ...
 */
class PhotonCommand extends ConsoleCommand
{
    ...
    protected function createComponent()
    {
        ...
        $folder_name = 'photon-' . strtolower($this->inflector->hyphenize($name));
...
=======
>>>>>>> 78468598f4ae8dfbef4be265f0c3dbd2a641e05e
            if ($type != 'blueprint') {
                rename(
                  $component_folder . DS . $type . '.php',
                  $component_folder . DS . $folder_name . '.php');
                rename(
                ...
                rename(
                  $component_folder . DS . 'assets' . DS . $type . '.js',
                  $component_folder . DS . 'assets' . DS . $filename . '.js');
                rename(
                  $component_folder . DS . 'blueprints' . DS . $type . '.yaml',
                  $component_folder . DS . 'blueprints' . DS . $filename . '.yaml');
                rename(
